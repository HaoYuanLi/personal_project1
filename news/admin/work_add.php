      ...
      <div class="col col-xs-12">
        <form id="add_form">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="intro" placeholder="請勿輸入',因使用nl2br隔行,用了會產生bug" rows="10" required></textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <div style="margin-top:5px;" class="show_video"></div>
          </div>
          <div class="form-group">
            <label for="youtube_link">Youtube影片上傳(範例:https://www.youtube.com/watch?v=123,貼上123即可)</label><br>
            <input type="text" id="youtube_link" autocomplete="off">
            <button style="margin-bottom:5px;margin-left:112px;" type="button" class="btn btn-danger" id="del_youtube_link">清空字串</button>
          </div>
          ...
          <div align="center"><button type="submit" class="btn btn-primary">確認新增</button></div>
        </form>
      </div>
    </div>
  </div>
